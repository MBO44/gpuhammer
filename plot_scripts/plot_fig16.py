...
if __name__ == "__main__":
    ...
    INPUT_DIR = os.path.join(HAMMER_ROOT, "results", "fig16", "raw_files")
    OUTPUT_DIR = os.path.join(HAMMER_ROOT, "results", f"fig16_flip{i}")
    ...
    output_image = os.path.join(OUTPUT_DIR, f"fig16_flip{i}.pdf")
