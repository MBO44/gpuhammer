...
num_agg=12          # Number of aggressors
num_warp=12          # Number of warps
num_thread=1        # Number of threads per warp
round=2             # No. of round per tREFI, each round hammers <num_agg> rows
...
time_file="$HAMMER_ROOT/results/fig10/delay_12w.txt"
